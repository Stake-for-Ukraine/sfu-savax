...
/** 
    ...
    @notice Harvets Manager is a contract that is used to manage the process of swapping yield generated by sfuAVAX vault 
    ...
    @dev Swap and distribute strategies are stored in the /strategies folder. Since this contract supports swaping any ERC-20 tokens,
...
contract HarvestManager {
    ...
    /** 
        @notice The function that users (keepers) call to swap harvested yield for an assets suitable for donation (e.g. stablecoin). 
        ...
        @param _token0 The address of the token that is swapped (usually sAVAX, but also can be used to swap any other 
        ERC-20 tokens sent to manager by mistake).
        @param _token1 The address of the token that is received after swap (e.g. USDC)
    */
    ...
    /**
        @notice The function that users (keepers) call to distribute harvested yield to beneficiaries after it was 
        ...
        @param _distributionToken The address of the token that is distributed (usually USDC, but also can be used 
        to distribute any other ERC-20 tokens sent to manager by mistake).
    */
